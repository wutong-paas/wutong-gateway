...
import (
	...
	"github.com/wutong-paas/wutong-gateway/internal/annotations"
	...
	"github.com/wutong-paas/wutong-gateway/internal/controller/config"
	istroe "github.com/wutong-paas/wutong-gateway/internal/controller/store"
	"github.com/wutong-paas/wutong-gateway/internal/defaults"
	v1 "github.com/wutong-paas/wutong-gateway/internal/v1"
	"github.com/wutong-paas/wutong-gateway/util"
	coreutil "github.com/wutong-paas/wutong-gateway/util"
	ik8s "github.com/wutong-paas/wutong-gateway/util/k8s"
...
const ingressClassName = "wutong-gateway"
...
func New(client kubernetes.Interface,
	...
	store.sharedInformer = informers.NewSharedInformerFactory(client, conf.ResyncPeriod)
...
func (s *k8sStore) ingressIsValid(ingress interface{}) bool {
	if !isEffectivedIngress(ingress) {
		return false
	}
